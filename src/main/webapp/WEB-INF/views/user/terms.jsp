...
<div id="terms_content" class="terms_c">
	<div>
		<h1>이용약관</h1>
		<form id="terms_form" class="terms_f" action="terms_form">
			<h4 class="terms_h">●이용약관</h4>
			<textarea>
		제 1 장 총칙
...
(시행일) 본 약관은 2018년 8월 1일부터 시행됩니다. 개정된 약관의 적용일자 이전 이용자 또는 회원은 개정된 이용약관의 적용을 받습니다.
			...
			<p>
				<input type="checkbox" id="terms_check1" name="term_chk" /> 위의 약관에 동의 합니다.<br />
			</p>
			<h4 class="terms_h">●개인정보 수집/이용동의</h4>
			<textarea>
		1. 개인정보의 수집항목 및 수집방법 
  ...
  * 수탁업체
    ...
    - 행정자치부
      ...
      · 개인정보 보유 및 이용 기간 : 행정자치부에서는 이미 보유하고 있는 개인정보이기 때문에 별도로 저장하지 않음
			...
			<p>
				<input type="checkbox" id="terms_check2" name="term_chk" /> 위의 약관에 동의 합니다.<br />
			</p>
			<p>
				<input type="button" id="terms_btn" class="terms_btn" value="동의하기" onclick="chk()" />
			</p>
		</form>
	</div>
</div>
...
function chk(){
	 var chk1 = document.getElementById("terms_check1").checked;
	 var chk2 = document.getElementById("terms_check2").checked;
