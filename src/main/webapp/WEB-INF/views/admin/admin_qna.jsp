...
<body>
	<div id="bodywrap" class="container">
		...
		<!-- 검색창 -->
		<form action="aqna.do?list=admin" method="get">
			<div class="form-wrap">
			...
			<div class="row g-4" >
				<c:forEach items="${aList}" var="dto" varStatus="status">
					<div class="col-2">
						...
						<a href="${path}">
							<div class="card">
								<img src="resources/board/qna/${dto.upload}" class="card-img-top" alt="..." onerror="this.src='resources/images/noimg.png'" height="200px">
								<div class="card-body">
									<div>
         ...
         <div class="pagelist text-center">
          <ul class="pagination justify-content-center" >
            ...
            <c:if test="${pv.startPage>1}">
               <a href="aqna.do?currentPage=${pv.startPage-pv.blockPage}"class="page-link text-dark text-decoration-none" aria-label="Next">&laquo;</a>
            </c:if>
            <!-- 이전 출력 끝 -->

            <!-- 페이지 출력 시작 -->
            <c:forEach var="i" begin="${pv.startPage}" end="${pv.endPage}">
               <span> <c:url var="currPage" value="aqna.do">
            ...
            <c:if test="${pv.endPage<pv.totalPage}">
               <a href="aqna.do?currentPage=${pv.startPage+pv.blockPage}" class="page-link text-dark text-decoration-none" aria-label="Next">&raquo;</a>
            </c:if>
            <!-- 다음 출력 끝 -->
            </ul>
         </div>
