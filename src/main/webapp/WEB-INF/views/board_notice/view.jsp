			...
			<tbody>
					...
					<tr>
						<td>
							<div class="pt-4 pb-2" align="center">
								<img src="resources/board/notice/${dto.upload}" width="80%" />
							</div>
						</td>
					</tr>
				</c:if>
				...
				<tr>
					...
					<td><c:if test="${!empty dto.upload}">
							<a href="ncontentdownload.do?num=${dto.num}">
		...
		<c:choose>
			<c:when test="${user.usergrade==1 || user.usergrade==2}">
				<div class="card" style="width:80%;margin:0 auto;">
					<form name="frm" method="post" action="nrview.do" >
						<div class="card-body">
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$('.rupdate').click(function() {
			...
			$('#rfrm').attr("action", "nrupdate.do").submit();
		});
		...
		$('div>ol form').on('click', this, function(){
			...
			$(this).attr("action", "nrdelete.do").submit();
		})
	});
</script>
