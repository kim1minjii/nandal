...
public class PaldoPageDTO {
	...
	public PaldoPageDTO(int currentPage, int totalCount) {
	...
	public PaldoPageDTO(int currentPage, int totalCount, String searchkey, String searchWord) {
