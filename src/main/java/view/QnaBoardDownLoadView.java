...
public class QnaBoardDownLoadView extends AbstractView{

	private BoardDAO qna_dao;
	
	public QnaBoardDownLoadView() {
	...
	protected void renderMergedOutputModel(Map<String, Object> model, HttpServletRequest request,
		...
		String saveDirectory = root + "resources/board/qna" + File.separator;
		
		String upload = qna_dao.getFile(num);
