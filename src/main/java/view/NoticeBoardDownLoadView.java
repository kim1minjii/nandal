...
public class NoticeBoardDownLoadView extends AbstractView{

	private BoardDAO notice_dao;
	
	public NoticeBoardDownLoadView() {
	...
	protected void renderMergedOutputModel(Map<String, Object> model, HttpServletRequest request,
		...
		String saveDirectory = root + "resources/board/notice" + File.separator;
		
		String upload = notice_dao.getFile(num);
